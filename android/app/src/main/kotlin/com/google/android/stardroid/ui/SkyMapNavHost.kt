...
import com.google.android.stardroid.ui.deepsky.DeepSkyScreen
    ...
    NavHost(
        ...
        composable(Routes.MAP) {
            MapScreen(
                ...
                onOpenDeepSky = { navController.navigate(Routes.DEEP_SKY) },
        ...
        composable(Routes.DEEP_SKY) {
            // The engine wants the observer's position and nothing else from the app; it
            // keeps its own clock, catalogue and horizon. Passing the confirmed location
            // (and null until there is one) means the two sky views never disagree about
